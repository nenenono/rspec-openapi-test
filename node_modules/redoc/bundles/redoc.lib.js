...
`,Bc=ee(Tc)`
  margin: 0 5px 0 0;
`,Qc=ee((t=>{const{name:r,opened:n,className:o,onClick:i,httpVerb:s,deprecated:a}=t;return e.createElement(qc,{className:o,onClick:i||void 0},e.createElement(Bc,{type:s},gt(s)),e.createElement(Ci,{size:"1.5em",direction:n?"down":"right",float:"left"}),e.createElement(Fc,{$deprecated:a},r),a?e.createElement(Pi,{type:"warning"}," ",_("deprecated")," "):null)}))`
  padding: 10px;
  border-radius: 2px;
  margin-bottom: 4px;
  line-height: 1.5em;
